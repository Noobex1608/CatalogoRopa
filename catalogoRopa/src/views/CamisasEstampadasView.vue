    ...
    <div class="bg-white shadow-sm mb-6">
      <div class="container mx-auto px-6 py-6 max-w-[1600px]">
        <nav class="flex text-sm mb-4 tracking-wide">
          ...
          <span class="text-blue-700 font-medium">Camisas Estampadas</span>
        </nav>
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Camisas Estampadas</h1>
            <p class="text-sm text-gray-500 mt-1">
              {{ catalogoStore.camisasEstampadas.length }} productos disponibles
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="flex-1 order-2 lg:order-2">
          ...
          <div class="flex justify-between items-center mb-6">
            <p class="text-sm text-gray-600">
              <span class="font-medium text-gray-900">{{ catalogoStore.camisasEstampadas.length }}</span> productos encontrados
            </p>
            <select

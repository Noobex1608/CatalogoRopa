...
onMounted(() => {
  ...
  catalogoStore.cargarCamisasBordadas()
})
</script>
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p class="text-sm text-[#005F7F]">
              Mostrando <span class="font-bold text-[#002B42]">{{ catalogoStore.camisasBordadas.length }}</span>
              de {{ catalogoStore.camisasBordadasRaw.length }} diseños exclusivos
            </p>
          </div>
    ...
    <main class="container mx-auto px-4 sm:px-6 pb-20 max-w-[1600px]">
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="flex-1 order-2 lg:order-2">
          ...
          <!-- Sin resultados -->
          <div v-else-if="catalogoStore.camisasBordadas.length === 0" class="text-center py-20">
